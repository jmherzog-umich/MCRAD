...
#ifndef __POLYCYLGRID_H
#define __POLYCYLGRID_H

using namespace std;

struct PolyCylGrid : public Grid {
    //Data accessors
    ...
    virtual double Volume(long unsigned int i, long unsigned int j, long unsigned int k) const {
        //TODO: Account for volume outside of grid
    ...
    PolyCylGrid(double r, double z, unsigned int nr=20, unsigned int ntheta=0, unsigned int nz=0) {
        Lx = r; Lz = z;
        this->nx = nr;
